...
################################################################################
## Form generated from reading UI file 'updateItemUIamRnPG.ui'
##
...
"}")
        ...
        self.prodId_Label = QLabel(self.widget_102)
        self.prodId_Label.setObjectName(u"prodId_Label")
        self.prodId_Label.setMinimumSize(QSize(0, 35))
        self.prodId_Label.setMaximumSize(QSize(16777215, 35))
        font2 = QFont()
        font2.setFamilies([u"Poppins Medium"])
        font2.setPointSize(14)
        font2.setBold(False)
        self.prodId_Label.setFont(font2)
        self.prodId_Label.setStyleSheet(u"QLabel{\n"
"	color:white;\n"
"}")

        self.horizontalLayout_45.addWidget(self.prodId_Label)
...
"}")
        ...
        self.upProd_Name = QLineEdit(self.widget_102)
        self.upProd_Name.setObjectName(u"upProd_Name")
        sizePolicy2 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.upProd_Name.sizePolicy().hasHeightForWidth())
        self.upProd_Name.setSizePolicy(sizePolicy2)
        self.upProd_Name.setMinimumSize(QSize(200, 35))
        self.upProd_Name.setMaximumSize(QSize(16777215, 30))
        font3 = QFont()
        font3.setFamilies([u"Poppins Medium"])
        font3.setPointSize(11)
        self.upProd_Name.setFont(font3)
        self.upProd_Name.setStyleSheet(u"QLineEdit {\n"
...
"")
        ...
        self.horizontalLayout_3.addWidget(self.upProd_Name)
...
"}")
        ...
        self.upProd_Price = QLineEdit(self.widget_102)
        self.upProd_Price.setObjectName(u"upProd_Price")
        sizePolicy2.setHeightForWidth(self.upProd_Price.sizePolicy().hasHeightForWidth())
        self.upProd_Price.setSizePolicy(sizePolicy2)
        self.upProd_Price.setMinimumSize(QSize(200, 35))
        self.upProd_Price.setMaximumSize(QSize(16777215, 30))
        self.upProd_Price.setFont(font3)
        self.upProd_Price.setStyleSheet(u"QLineEdit {\n"
"    background-color: #1F1F1F;\n"
"    border: 1px solid #3B3B3B;\n"
"    border-radius: 5px;\n"
"    padding: 8px;\n"
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.upProd_Price)
...
"}")
        ...
        self.upProd_Category = QComboBox(self.widget_102)
        self.upProd_Category.addItem("")
        self.upProd_Category.addItem("")
        self.upProd_Category.setObjectName(u"upProd_Category")
        self.upProd_Category.setFont(font3)
        self.upProd_Category.setStyleSheet(u"QComboBox {\n"
"    background-color: #1F1F1F;\n"
"    border: 1px solid #3B3B3B;\n"
"    border-radius: 5px;\n"
"    padding: 8px;\n"
...
"")
        ...
        self.horizontalLayout_2.addWidget(self.upProd_Category)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prodId_Label.setText(QCoreApplication.translate("MainWindow", u"11234", None))
        ...
        self.upProd_Category.setItemText(0, QCoreApplication.translate("MainWindow", u"Coffee", None))
        self.upProd_Category.setItemText(1, QCoreApplication.translate("MainWindow", u"Non-Coffee", None))

        self.upProd_Category.setCurrentText("")
        self.upProd_Category.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Choose Category", None))
