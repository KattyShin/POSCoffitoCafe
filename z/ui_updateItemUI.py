...
class UpdateItemWindow(QMainWindow):
    def __init__(self):
        ...
        sizePolicy2.setHeightForWidth(
            self.upProd_Name.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(
            self.upProd_Price.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prodId_Label.setText(QCoreApplication.translate(
        ...
        self.upProd_Category.setItemText(
            0, QCoreApplication.translate("MainWindow", u"Coffee", None))
        self.upProd_Category.setItemText(1, QCoreApplication.translate(
            "MainWindow", u"Non-Coffee", None))

        self.upProd_Category.setCurrentText("")
        self.upProd_Category.setPlaceholderText(
