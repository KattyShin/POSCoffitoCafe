...
################################################################################
## Form generated from reading UI file 'admin_UI_v3jjFMZG.ui'
##
...
"}")
        ...
        self.pushButton_5.toggled.connect(MainWindow.showMaximized)
        self.pushButton_2.toggled.connect(MainWindow.showMinimized)
        self.pushButton_5.toggled.connect(MainWindow.showNormal)
