...
################################################################################
## Form generated from reading UI file 'admin_UI_v3yXocpa.ui'
##
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/iCons/icons/icons8-coffee-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/iCons/icons/icons8-coffee0-40.png", QSize(), QIcon.Normal, QIcon.On)
        self.dashboard1.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/iCons/icons/icons8-add-folder-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon3.addFile(u":/iCons/icons/icons8-add-40.png", QSize(), QIcon.Normal, QIcon.On)
        self.add_item1.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/iCons/icons/icons8-edit-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon4.addFile(u":/iCons/icons/icons8-edit-40 (1).png", QSize(), QIcon.Normal, QIcon.On)
        self.update_item1.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/iCons/icons/icons8-delete-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon5.addFile(u":/iCons/icons/icons8-delete-40(1).png", QSize(), QIcon.Normal, QIcon.On)
        self.delete_item1.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/iCons/icons/icons8-sales-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u":/iCons/icons/icons8-sales-40(1).png", QSize(), QIcon.Normal, QIcon.On)
        self.sales_report1.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/iCons/icons/personalization.png", QSize(), QIcon.Normal, QIcon.Off)
        self.mng_account1.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/iCons/icons/icons8-logout-40.png", QSize(), QIcon.Normal, QIcon.Off)
        icon8.addFile(u":/iCons/icons/icons8-logouto-40.png", QSize(), QIcon.Normal, QIcon.On)
        self.logout1.setIcon(icon8)
...
"")
        ...
        self.update_item2.setIcon(icon4)
        ...
        self.delete_item1_2.setIcon(icon5)
        ...
        self.sales_report2.setIcon(icon6)
        ...
        self.mng_account2.setIcon(icon7)
        ...
        self.add_prod_button.clicked["bool"].connect(self.add_prod_button.click)
