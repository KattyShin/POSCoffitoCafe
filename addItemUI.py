...
################################################################################
## Form generated from reading UI file 'addItemUITHJHAX.ui'
##
...
"}")
        ...
        self.horizontalSpacer_7 = QSpacerItem(171, 35, QSizePolicy.Expanding, QSizePolicy.Minimum)
...
"}")
        ...
        self.addProd_Name = QLineEdit(self.widget_102)
        self.addProd_Name.setObjectName(u"addProd_Name")
        sizePolicy2 = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.addProd_Name.sizePolicy().hasHeightForWidth())
        self.addProd_Name.setSizePolicy(sizePolicy2)
        self.addProd_Name.setMinimumSize(QSize(200, 35))
        self.addProd_Name.setMaximumSize(QSize(16777215, 30))
        font3 = QFont()
        font3.setFamilies([u"Poppins Medium"])
        font3.setPointSize(11)
        self.addProd_Name.setFont(font3)
        self.addProd_Name.setStyleSheet(u"QLineEdit {\n"
...
"")
        ...
        self.horizontalLayout_3.addWidget(self.addProd_Name)
...
"}")
        ...
        self.addProd_Price = QLineEdit(self.widget_102)
        self.addProd_Price.setObjectName(u"addProd_Price")
        sizePolicy2.setHeightForWidth(self.addProd_Price.sizePolicy().hasHeightForWidth())
        self.addProd_Price.setSizePolicy(sizePolicy2)
        self.addProd_Price.setMinimumSize(QSize(200, 35))
        self.addProd_Price.setMaximumSize(QSize(16777215, 30))
        self.addProd_Price.setFont(font3)
        self.addProd_Price.setStyleSheet(u"QLineEdit {\n"
"    background-color: #1F1F1F;\n"
"    border: 1px solid #3B3B3B;\n"
"    border-radius: 5px;\n"
"    padding: 8px;\n"
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.addProd_Price)
...
"}")
        ...
        self.addProd_Category = QComboBox(self.widget_102)
        self.addProd_Category.addItem("")
        self.addProd_Category.addItem("")
        self.addProd_Category.setObjectName(u"addProd_Category")
        self.addProd_Category.setFont(font3)
        self.addProd_Category.setStyleSheet(u"QComboBox {\n"
"    background-color: #1F1F1F;\n"
"    border: 1px solid #3B3B3B;\n"
"    border-radius: 5px;\n"
"    padding: 8px;\n"
...
"")
        ...
        self.horizontalLayout_2.addWidget(self.addProd_Category)
...
"}")
        ...
        self.addProdButton = QPushButton(self.widget_5)
        self.addProdButton.setObjectName(u"addProdButton")
        self.addProdButton.setMinimumSize(QSize(132, 31))
        self.addProdButton.setMaximumSize(QSize(16777215, 31))
        self.addProdButton.setFont(font4)
        self.addProdButton.setStyleSheet(u"QPushButton {\n"
"    padding: 6px 14px;\n"
"    font-family: \"Roboto\", sans-serif;\n"
"    border-radius: 6px;\n"
"    border: none;\n"
...
"    background-color: #FFA54E; \n"
"}")
        self.addProdButton.setCheckable(True)
        self.addProdButton.setAutoExclusive(True)

        self.horizontalLayout_5.addWidget(self.addProdButton)
        ...
        self.cancelUpdateBtn.pressed.connect(self.close)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_37.setText(QCoreApplication.translate("MainWindow", u"Add Item", None))
        ...
        self.addProd_Category.setItemText(0, QCoreApplication.translate("MainWindow", u"Coffee", None))
        self.addProd_Category.setItemText(1, QCoreApplication.translate("MainWindow", u"Non-Coffee", None))

        self.addProd_Category.setCurrentText("")
        self.addProd_Category.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Choose Category", None))
        self.cancelUpdateBtn.setText(QCoreApplication.translate("MainWindow", u"Cancel", None))
        self.addProdButton.setText(QCoreApplication.translate("MainWindow", u"Add", None))
    # retranslateUi
    ...
    def clear_text(self):
        if hasattr(self, 'line_edit_product_id'):
            self.line_edit_product_id.clear()
        if hasattr(self, 'line_edit_product_name'):
            self.line_edit_product_name.clear()
        if hasattr(self, 'line_edit_product_price'):
            self.line_edit_product_price.clear()
        if hasattr(self, 'combo_box_category'):
            self.combo_box_category.setCurrentIndex(-1) 

        self.finished.connect(self.clear_text)
